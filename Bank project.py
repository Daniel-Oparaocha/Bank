...
class LoginWindow:
    ...
    def validate_login(self, account_number, pin):
        self.account_number = "1234566789"
        self.pin = "2468"
...
class BankAccountWindow(Toplevel):
    ...
    def open_savings_account_window(self):
        self.withdraw()
        account_number = "1234566789"  # Replace with the actual account number
...
class SavingsAccountWindow(Toplevel):
    def __init__(self, account_number, initial_balance=0, withdrawal_limit=17000):
        super().__init__()
